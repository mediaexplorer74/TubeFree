...
// Type: AngleSharp.Dom.Css.OrientationMediaFeature
...
namespace AngleSharp.Dom.Css
{
  internal sealed class OrientationMediaFeature : MediaFeature
  {
    ...
    internal override IValueConverter Converter => OrientationMediaFeature.TheConverter;

    public override bool Validate(RenderDevice device) => device.DeviceHeight < device.DeviceWidth;
  }
}
