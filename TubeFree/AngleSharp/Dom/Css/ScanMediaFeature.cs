...
// Type: AngleSharp.Dom.Css.ScanMediaFeature
...
namespace AngleSharp.Dom.Css
{
  internal sealed class ScanMediaFeature : MediaFeature
  {
    ...
    internal override IValueConverter Converter => ScanMediaFeature.TheConverter;

    public override bool Validate(RenderDevice device) => !device.IsInterlaced;
  }
}
