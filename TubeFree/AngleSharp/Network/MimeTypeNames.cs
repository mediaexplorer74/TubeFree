...
// Type: AngleSharp.Network.MimeTypeNames
...
namespace AngleSharp.Network
{
  ...
  {
    private static Dictionary<string, string> Extensions = new Dictionary<string, string>((IEqualityComparer<string>) StringComparer.OrdinalIgnoreCase)
    {
      {
        ".3dm",
        "x-world/x-3dmf"
    ...
    private static readonly string[] commonJsTypes = new string[16]
    {
    ...
    public static string FromExtension(string extension)
    {
      ...
      return MimeTypeNames.Extensions.TryGetValue(extension, out empty) ? empty : MimeTypeNames.Binary;
    }

    public static bool IsJavaScript(string type)
    {
      foreach (string commonJsType in MimeTypeNames.commonJsTypes)
      {
    ...
    {
      MimeType other = new MimeType(content);
