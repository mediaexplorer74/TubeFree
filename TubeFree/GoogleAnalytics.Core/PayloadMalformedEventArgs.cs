...
// Type: GoogleAnalytics.Core.PayloadMalformedEventArgs
...
namespace GoogleAnalytics.Core
{
  ...
  [Version(16974073)]
  [CompilerGenerated]
  public sealed class PayloadMalformedEventArgs : IPayloadMalformedEventArgsClass, IStringable
  {
    public extern int HttpStatusCode { [MethodImpl] get; }
