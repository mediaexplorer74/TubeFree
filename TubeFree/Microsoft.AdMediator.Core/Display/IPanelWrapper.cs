...
// Type: Microsoft.AdMediator.Core.Display.IPanelWrapper
...
{
  internal interface IPanelWrapper : IUIElementWrapper
  {
    void AddChild(IUIElementWrapper element);

    void RemoveChild(IUIElementWrapper element);
  }
}
