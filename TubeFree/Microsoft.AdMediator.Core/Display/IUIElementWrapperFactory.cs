...
// Type: Microsoft.AdMediator.Core.Display.IUIElementWrapperFactory
...
{
  internal interface IUIElementWrapperFactory
  {
    IUIElementWrapper CreateControl(object control, Type controlType);
  }
}
