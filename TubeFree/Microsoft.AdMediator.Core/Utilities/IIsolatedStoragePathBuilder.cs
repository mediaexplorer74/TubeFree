...
// Type: Microsoft.AdMediator.Core.Utilities.IIsolatedStoragePathBuilder
...
{
  internal interface IIsolatedStoragePathBuilder
  {
    Task<string> BuildFullPathForIsolatedStorageAsync(string relativePath);

    Task<string[]> RetrieveRootFolderComponentsAsync();
  }
}
