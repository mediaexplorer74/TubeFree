...
// Type: Microsoft.Advertising.Shared.WinRT.AdSchedule
...
namespace Microsoft.Advertising.Shared.WinRT
{
  ...
  [MarshalingBehavior]
  [Threading]
  public sealed class AdSchedule : __IAdSchedulePublicNonVirtuals
  {
    public extern IVectorView<AdPod> Pods { [MethodImpl(MethodCodeType = MethodCodeType.Runtime)] get; }
  }
}
