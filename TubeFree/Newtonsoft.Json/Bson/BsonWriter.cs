...
namespace Newtonsoft.Json.Bson
{
  ...
  public class BsonWriter : JsonWriter
  {
    ...
    public override void WriteComment(string text) => throw JsonWriterException.Create((JsonWriter) this, "Cannot write JSON comment as BSON.", (Exception) null);

    public override void WriteStartConstructor(string name) => throw JsonWriterException.Create((JsonWriter) this, "Cannot write JSON constructor as BSON.", (Exception) null);

    public override void WriteRaw(string json) => throw JsonWriterException.Create((JsonWriter) this, "Cannot write raw JSON as BSON.", (Exception) null);

    public override void WriteRawValue(string json) => throw JsonWriterException.Create((JsonWriter) this, "Cannot write raw JSON as BSON.", (Exception) null);
