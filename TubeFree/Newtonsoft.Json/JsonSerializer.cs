...
namespace Newtonsoft.Json
{
  public class JsonSerializer
  {
    ...
    public virtual Newtonsoft.Json.SerializationBinder Binder
    {
      get
      {
        if (this._serializationBinder == null)
          return (Newtonsoft.Json.SerializationBinder) null;
        if (this._serializationBinder is Newtonsoft.Json.SerializationBinder serializationBinder1)
