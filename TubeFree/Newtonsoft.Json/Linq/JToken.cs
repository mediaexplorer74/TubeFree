      ...
      if (JsonConvert.DefaultSettings == null)
      {
        ...
        if (isEnum)
        {
          if (this.Type == JTokenType.String)
          {
            ...
            {
              throw new ArgumentException("Could not convert '{0}' to {1}.".FormatWith((IFormatProvider) CultureInfo.InvariantCulture, (object) (string) this, (object) (objectType.IsEnum() ? objectType : Nullable.GetUnderlyingType(objectType)).Name), ex);
            }
          }
