      ...
      switch (token.Type)
      {
        ...
        case JTokenType.Date:
          ...
          if (obj1 is DateTime dateTime)
            obj1 = (object) DateTimeUtils.EnsureDateTime(dateTime, this.DateTimeZoneHandling);
        ...
        case JTokenType.Uri:
          ...
          this.SetToken(JsonToken.String, obj2 is Uri uri ? (object) uri.OriginalString : (object) this.SafeToString(obj2));
          break;
