...
namespace Newtonsoft.Json.Schema
{
  ...
  internal class JsonSchemaModelBuilder
  {
    ...
    public void AddAdditionalItems(JsonSchemaNode parentNode, JsonSchema schema) => parentNode.AdditionalItems = this.AddSchema(parentNode.AdditionalItems, schema);
