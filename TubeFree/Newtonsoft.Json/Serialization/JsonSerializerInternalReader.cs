...
namespace Newtonsoft.Json.Serialization
{
  internal class JsonSerializerInternalReader : JsonSerializerInternalBase
  {
    ...
    private JsonContract GetContractSafe(Type type) => type == null ? (JsonContract) null : this.Serializer._contractResolver.ResolveContract(type);
    ...
    private static bool CoerceEmptyStringToNull(Type objectType, JsonContract contract, string s) => string.IsNullOrEmpty(s) && objectType != null && objectType != typeof (string) && objectType != typeof (object) && contract != null && contract.IsNullable;
