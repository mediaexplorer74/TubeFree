...
namespace Newtonsoft.Json.Utilities
{
    ...
    ICollection
  {
    ...
    public bool ContainsKey(TKey key)
    {
      ...
      return this._readOnlyDictionary != null ? this._readOnlyDictionary.ContainsKey(key) : this._genericDictionary.ContainsKey(key);
    }
    ...
    public bool Contains(KeyValuePair<TKey, TValue> item)
    {
      ...
      return this._readOnlyDictionary != null ? this._readOnlyDictionary.Contains<KeyValuePair<TKey, TValue>>(item) : this._genericDictionary.Contains(item);
    }
    ...
    IDictionaryEnumerator IDictionary.GetEnumerator()
    {
      ...
      return this._readOnlyDictionary != null ? (IDictionaryEnumerator) new DictionaryWrapper<TKey, TValue>.DictionaryEnumerator<TKey, TValue>(this._readOnlyDictionary.GetEnumerator()) : (IDictionaryEnumerator) new DictionaryWrapper<TKey, TValue>.DictionaryEnumerator<TKey, TValue>(this._genericDictionary.GetEnumerator());
    }
