...
namespace Newtonsoft.Json.Utilities
{
  internal sealed class DynamicProxyMetaObject<T> : DynamicMetaObject
  {
    ...
    private BindingRestrictions GetRestrictions() => this.Value != null || !this.HasValue ? BindingRestrictions.GetTypeRestriction(this.Expression, this.LimitType) : BindingRestrictions.GetInstanceRestriction(this.Expression, (object) null);
