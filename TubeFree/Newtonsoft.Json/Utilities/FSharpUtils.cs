...
namespace Newtonsoft.Json.Utilities
{
  internal static class FSharpUtils
  {
    ...
    {
      ObjectConstructor<object> ctorDelegate = JsonTypeReflector.ReflectionDelegateFactory.CreateParameterizedConstructor((MethodBase) FSharpUtils._mapType.MakeGenericType(typeof (TKey), typeof (TValue)).GetConstructor((IList<Type>) new Type[1]
      {
