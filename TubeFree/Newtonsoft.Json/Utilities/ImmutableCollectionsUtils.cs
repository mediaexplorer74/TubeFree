      ...
      out ObjectConstructor<object> parameterizedCreator)
    {
      if (underlyingType.IsGenericType())
      {
        ...
        if (collectionTypeInfo != null)
        {
          ...
          {
            MethodInfo methodInfo = type2.GetMethods().FirstOrDefault<MethodInfo>((Func<MethodInfo, bool>) (m => m.Name == "CreateRange" && m.GetParameters().Length == 1));
            if (methodInfo != null)
            {
      ...
      out ObjectConstructor<object> parameterizedCreator)
    {
      if (underlyingType.IsGenericType())
      {
        ...
        if (collectionTypeInfo != null)
        {
          ...
          if (type1 != null && type2 != null)
          {
            MethodInfo methodInfo = type2.GetMethods().FirstOrDefault<MethodInfo>((Func<MethodInfo, bool>) (m =>
            {
